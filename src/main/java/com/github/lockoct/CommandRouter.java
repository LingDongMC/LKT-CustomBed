...
import com.github.lockoct.bed.command.bed.BedCommandHandler;
import com.github.lockoct.bed.command.mark.MarkCommandHandler;
...
public class CommandRouter extends BaseCommandRouter {
        ...
        if (sender instanceof Player player) {
            if (args.length > 0) {
                ...
                switch (args[0]) {
                    ...
                    case "bed" -> BedCommandHandler.getInstance().execute(sender, subCmdArgs);
    ...
    public List<String> onTabComplete(@Nonnull CommandSender commandSender, @Nonnull Command command, @Nonnull String label, @Nonnull String[] args) {
        ...
        switch (args.length) {
            case 1:
                cmdList = new ArrayList<>(Arrays.asList("mark", "bed"));
